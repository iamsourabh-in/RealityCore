...
namespace AWS.Cognito.Core
{
    public class CognitoHelper
    {
        ...
        private string POOL_ID = "us-east-1_XuFaC2J8u"; //ConfigurationManager.AppSettings["POOL_id"];
        private string CLIENTAPP_ID = "12vfn2j598qa5k7kofeakf1md2";// ConfigurationManager.AppSettings["CLIENT_id"];
